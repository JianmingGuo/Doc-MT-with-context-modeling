...
# from discriminator import DisCNN
# from share_function import deal_generated_samples, extend_sentence_to_maxlen
...
def generate_samples(config):
    ...
    with default_graph.as_default():
        ...
        generator.build_generate(max_len=config.train.max_length, generate_devices=config.train.devices,
                                 optimizer=config.train.optimizer)  ##here
        generator.init_and_restore()
        # generator.init_and_restore('./pretrain/model_generator_fren/model_step_17500')
        print("Load Finish")
...
if __name__ == "__main__":
    ...
    logging.basicConfig(filename=config.train.logdir+"/samples.log", level=logging.DEBUG)
